...
meta =
{
    ...
    id = "wakemasters_automated_trading",
    ...
    name = "wakemasters_automated_trading",

    -- Title of your mod that will be displayed to players
    title = "Wakemaster's Automated Trading",

    -- Description of your mod that will be displayed to players
    description = "Improved Automated trading system",

    -- Insert all authors into this list
    authors = {"wakemaster39"},
    ...
    -- },
    dependencies = {
        {id="Avorion", min="0.29.*", max="0.30.*"} -- we must be using avorion with the economy system improvements
    },
    ...
    contact = "wakemaster39@gmail.com",
}
